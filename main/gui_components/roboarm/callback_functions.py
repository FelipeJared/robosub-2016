...
def saveValuesToFile(servoModelName):
    previous_state_logging_system.Log('gui_components/roboarm/_Saved_Values_/Saved_{}_GUI&RAM_Values.txt'.format(servoModelName)).writeParameters(positionCheckBox = window.printCheckBoxValArray[0].get(), speedCheckBox = window.printCheckBoxValArray[1].get(), voltageCheckBox = window.printCheckBoxValArray[2].get(), loadCheckBox = window.printCheckBoxValArray[3].get(), temperatureCheckBox = window.printCheckBoxValArray[4].get(), 
...
def escape(event):
    if event.keycode == 27: #Escape character; terminate program
        ...
        previous_state_logging_system.Log('gui_components/roboarm/_Saved_Values_/Last_Servo_Model_Used.txt').writeParameters(lastServoModel = "'"+window.dropBoxServoModelVariable.get()+"'")#Adding tick marks here since apparently in the previous state logging system, it will think the letters are a variable that doesnt exsist instead of a string
...
class ExportConfigValues:
    def __init__(self):
        ...
        if not os.path.exists('gui_components/roboarm/_Saved_Values_/RAM_EEPROM_Config_Sliders'):
            os.mkdir('gui_components/roboarm/_Saved_Values_/RAM_EEPROM_Config_Sliders')
        
    def ok(self, *event):
        previous_state_logging_system.Log('gui_components/roboarm/_Saved_Values_/RAM_EEPROM_Config_Sliders/'+self.userInput.get()+'.txt').writeParameters(dropBoxFwdKinematicsSelectorVariable = "'"+window.dropBoxFwdKinematicsSelectorVariable.get()+"'", dropBoxInvKinematicsSelectorVariable = "'"+window.dropBoxInvKinematicsSelectorVariable.get()+"'",
                                                                                                                                   invKinSolutionNumber = "'"+window.invKinSolutionNumber.get()+"'",
                                                                                                                                   movingSpeed1 = window.config1Scales[0][0].get(), movingSpeed2 = window.config1Scales[0][1].get(), movingSpeed3 = window.config1Scales[0][2].get(), movingSpeed4 = window.config1Scales[0][3].get(), movingSpeed5 = window.config1Scales[0][4].get(), movingSpeed6 = window.config1Scales[0][5].get(), movingSpeed7 = window.config1Scales[0][6].get(), movingSpeed8 = window.config1Scales[0][7].get(),
                                                                                                                                   torqueLimit1 = window.config1Scales[1][0].get(), torqueLimit2 = window.config1Scales[1][1].get(), torqueLimit3 = window.config1Scales[1][2].get(), torqueLimit4 = window.config1Scales[1][3].get(), torqueLimit5 = window.config1Scales[1][4].get(), torqueLimit6 = window.config1Scales[1][5].get(), torqueLimit7 = window.config1Scales[1][6].get(), torqueLimit8 = window.config1Scales[1][7].get(),
